...
- `check_ai12_release_gates.sh`: validates the categorized privacy corpus, exact AI-off output equivalence, Helper maximum-frame/saturation/deadline contracts, model notices, and the AI Lite Go / Writer No-Go release profile.
