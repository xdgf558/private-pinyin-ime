...
- Fixed Windows White Frost imports when the user profile or temporary path contains spaces, explicitly enabled TLS 1.2 for GitHub Release downloads, and surfaced the exact failing stage instead of a generic combined error.
