...
- Added ABC-03 gentle learning across macOS, Windows, and iOS through the existing shared user lexicon. The first two decayed confirmations remain warm-up data and cannot move the ordinary default candidate or activate learned bigram, trigram, short-phrase, continuous-transition, or AI Lite learning boosts; the third confirmation begins contributing ranking weight, and normal 30-day decay can return an old preference to warm-up without deleting its history.
