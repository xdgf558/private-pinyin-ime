...
- Added light typing haptics and command-selection feedback to the iOS keyboard. Nine-key composition now displays readable letter groups when candidate pinyin is not yet available instead of exposing internal digit signatures such as `95546`.
