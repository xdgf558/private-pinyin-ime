...
impl Syllable {
    pub fn new(text: String, is_prefix: bool) -> Self {
        Self { text, is_prefix }
    }
}

pub fn is_legal_syllable(candidate: &str) -> bool {
    LEGAL_SYLLABLES.binary_search(&candidate).is_ok()
}

pub fn is_syllable_prefix(candidate: &str) -> bool {
    !candidate.is_empty()
        && LEGAL_SYLLABLES
            .iter()
            .any(|syllable| syllable.starts_with(candidate))
}

const LEGAL_SYLLABLES: &[&str] = &[
    ...
    "long", "lou", "lu", "luan", "lun", "luo", "lü", "lüe", "ma", "mai", "man", "mang", "mao",
    "me", "mei", "men", "meng", "mi", "mian", "miao", "mie", "min", "ming", "miu", "mo", "mou",
    "mu", "na", "nai", "nan", "nang", "nao", "ne", "nei", "nen", "neng", "ni", "nian", "niang",
    "niao", "nie", "nin", "ning", "niu", "nong", "nou", "nu", "nuan", "nun", "nuo", "nü", "nüe",
    ...
    "se", "sen", "seng", "sha", "shai", "shan", "shang", "shao", "she", "shen", "sheng", "shi",
