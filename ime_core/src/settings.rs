...
pub struct ImeSettings {
    ...
    pub rime_ice_lexicon_path: Option<PathBuf>,
    pub enable_rime_ice_lexicon: bool,
    pub rime_frost_lexicon_path: Option<PathBuf>,
    pub enable_rime_frost_lexicon: bool,
...
impl Default for ImeSettings {
    fn default() -> Self {
        Self {
            ...
            rime_ice_lexicon_path: None,
            enable_rime_ice_lexicon: false,
            rime_frost_lexicon_path: None,
